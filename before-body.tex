...
%\pagenumbering{gobble} %use para remover a numeração de todas as páginas (tbm funciona no corpo do documento)
...
\end{center}
\thispagestyle{empty} %remove a numeração da pagina
\begin{center}
